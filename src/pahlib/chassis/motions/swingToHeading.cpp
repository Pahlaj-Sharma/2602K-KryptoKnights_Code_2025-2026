...
void pahlib::Chassis::swingToHeading(float theta, DriveSide lockedSide, int timeout, SwingToHeadingParams params,
    ...
    if (async) {
        pros::Task task([&]() { swingToHeading(theta, lockedSide, timeout, params, angularGains, false); });
        this->endMotion();
