...
void auton1() {
    ...
    chassis.moveTo(-27, 21.5, 61, 1000, {.minSpeed = 5});
    ...
    chassis.turnTo(135, 500);
    chassis.waitUntilDone();
    chassis.tank(-25, -45, true);
    toggle_score(true, 90, -120);
    pros::delay(500);
    toggle_score(true, -75, -10);
    pros::delay(300);
    toggle_score(true, 90, -120);
    pros::delay(700);
    chassis.tank(-25, -45, true);
...
void auton7() {
    ...
    pros::delay(250);
    chassis.tank(0, 0, true);
    chassis.moveTo(-46, -35, 2000, {.maxSpeed = 100, .minSpeed = 15, .earlyExitRange = 3});
    chassis.setBrakeMode(pros::E_MOTOR_BRAKE_HOLD);
    chassis.waitUntil(5);
    matchLoad.set_value(true);
    chassis.waitUntilDone();
    ...
    chassis.moveTo(-78, -45, 270, 900, {.lead = 0, .maxSpeed = 58});
    toggle_preroller(true, 100);
    chassis.waitUntilDone();
    pros::delay(150);
    chassis.moveTo(-15, -47, 270, 800, {.forwards = false, .maxSpeed = 100, .minSpeed = 20});
    chassis.setBrakeMode(pros::E_MOTOR_BRAKE_COAST);
    chassis.waitUntil(8);
    toggle_score(true, 80, 10);
    chassis.waitUntil(35);
    ...
    matchLoad.set_value(true);
    chassis.turnTo(0, 500, {.minSpeed = 35, .earlyExitRange = 3});
    chassis.moveTo(-22, 28, 1000, {.maxSpeed = 70, .minSpeed = 10, .earlyExitRange = 1});
    matchLoad.set_value(false);
    chassis.waitUntilDone();
    pros::delay(150);
    chassis.setBrakeMode(pros::E_MOTOR_BRAKE_HOLD);
    matchLoad.set_value(true);
    pros::delay(0);
    chassis.moveTo(-40, 40, 1000, {.minSpeed = 20, .earlyExitRange = 3});
    chassis.setBrakeMode(pros::E_MOTOR_BRAKE_COAST);
    chassis.turnTo(270, 500, {.minSpeed = 20, .earlyExitRange = 3});
    chassis.waitUntilDone();
    reset.updateBotPose(&right_rcl);
    //chassis.resetOdometry();
    pros::delay(50);
    chassis.moveTo(-20, 47, 270, 1000, {.forwards = false, .minSpeed = 10});
    chassis.waitUntilDone();
    score.set_value(true);
    toggle_score(true, 127, 127);
    pros::delay(1000);
    chassis.setPose(-29.25, 47, chassis.getPose().theta); // CHAGE THETA TO THE CHASSIS VALUE chassis.getPose().theta
    chassis.setBrakeMode(pros::E_MOTOR_BRAKE_HOLD);
    chassis.moveTo(-78, 47, 270, 1000, {.maxSpeed = 58});
    toggle_score(false);
    toggle_preroller(true);
    score.set_value(false);
    chassis.waitUntilDone();
    ...
    pros::delay(400);
    chassis.moveTo(chassis.getPose().x + 8, chassis.getPose().y - 2, 500, {.forwards = false, .minSpeed = 20, .earlyExitRange = 3});
    chassis.moveTo(-14, 6, 315, 1500, {.forwards = false, .minSpeed = 20});
