 ...
 * see https://www.vexforum.com/t/expo-drive-pahlibs-implementation for a detailed explanation
 */
class ExpoDriveCurve : public DriveCurve {
    public:
         ...
         * pahlib::ExpoDriveCurve driveCurve(5, 12, 1.132);
         * @endcode
         */
