...
#include "pahlib/asset.hpp"
#include "pahlib/chassis/trackingWheel.hpp"
#include "pahlib/pose.hpp"
#include "pahlib/pid.hpp"
#include "pahlib/exitcondition.hpp"
#include "pahlib/driveCurve.hpp"
#include <optional>
...
class OdomSensors {
    public:
         ...
         * pahlib::TrackingWheel vertical1(&vertical_rotation, pahlib::Omniwheel::NEW_275, 0.5);
         * pahlib::OdomSensors sensors(&vertical1, // vertical tracking wheel
...
class ControllerSettings {
    public:
         ...
         * @b Example
         * @code {.cpp}
         * pahlib::ControllerSettings lateralSettings(10, // proportional gain (kP)
...
class Drivetrain {
    public:
         ...
         *
         * pahlib::Drivetrain drivetrain(&leftMotors, // left motor group
         *                               &rightMotors, // right motor group
         *                               10, // 10 inch track width
         *                               pahlib::Omniwheel::NEW_4, // using new 4" omnis
...
class Chassis {
    public:
         ...
         * @code {.cpp}
         * // set the pose of the chassis to x = 0, y = 0, theta = 0
         * pahlib::Pose poseA(0, 0, 0);
         * chassis.setPose(poseA);
         * // set the pose of the chassis to x = 5.3, y = 12.2, theta = 3.14
         * // this time with theta in radians
         * pahlib::Pose poseB(5.3, 12.2, 3.14);
        ...
        */
         ...
         * @endcode
         */
        void resetOdometry(float threshold = 40, bool force = false);
        /**
