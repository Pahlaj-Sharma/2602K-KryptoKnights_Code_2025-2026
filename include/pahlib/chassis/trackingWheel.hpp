 ...
 */
namespace Omniwheel {
constexpr float NEW_2 = 2.007868;
...
class TrackingWheel {
    public:
         ...
         * pahlib::TrackingWheel verticalTrackingWheel(&verticalEncoder, pahlib::Omniwheel::NEW_275, -5);
         ...
         * pahlib::TrackingWheel horizontalTrackingWheel(&horizontalEncoder, pahlib::Omniwheel::OLD_325, -2, 5.0/3.0);
         * @endcode
         */
         ...
         * // the rpm is 360
         * pahlib::TrackingWheel leftTrackingWheel(&leftMotors, pahlib::Omniwheel::OLD_4, -5, 360);
         * @endcode
         */
         ...
         *
         * If you are using odometry provided by pahlib, this will automatically be called when
         ...
         *     pahlib::TrackingWheel exampleTrackingWheel(&exampleEncoder, pahlib::Omniwheel::NEW_275, 0.5);
         ...
         *     pahlib::TrackingWheel exampleTrackingWheel(&exampleRotationSensor, pahlib::Omniwheel::NEW_275, 0.5);
