 ...
 *
 * This is the primary way of interacting with the telemetry portion of pahlib's logging implementation. This sink is
 ...
 * <h3> Example Usage </h3>
 * @code
 * pahlib::telemetrySink()->setLowestLevel(pahlib::Level::INFO);
 * pahlib::telemetrySink()->info("{},{}", motor1.get_temperature(), motor2.get_temperature());
 * @endcode
 */
