...
namespace pahlib {
/**
 * @brief A base for any sink in pahlib to implement.
 *
 * Sinks are pahlib's abstraction for destinations that logged messages can be sent to. They are the backbone of the
...
class BaseSink {
    public:
         ...
         * <h3> Example Usage </h3>
         * @code
         * pahlib::BaseSink combinedSink({pahlib::telemetrySink(), pahlib::infoSink()});
         ...
         * <h3> Example Usage </h3>
         * @code
         * sink.log(pahlib::Level::INFO, "{} from the logger!", "Hello");
         * @endcode
    ...
    protected:
         ...
         * <h3> Example Usage </h3>
         * @code
         * infoSink()->setFormat("[pahlib] -- {time} -- {level}: {Message}");
         * infoSink()->info("hello");
         * // This will be formatted as:
         * // "[pahlib] -- 10 -- INFO:  hello"
         * @endcode
         */
