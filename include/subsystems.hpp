...
void toggle_preroller(bool toggled, int vel = 100); // Function to toggle the preroller

void toggle_score(bool toggled, int vel = 100); // Function to toggle the scoring motor
